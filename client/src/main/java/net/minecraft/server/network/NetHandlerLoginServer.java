            ...
            (new Thread("User Authenticator #" + AUTHENTICATOR_THREAD_ID.incrementAndGet())
            {
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        NetHandlerLoginServer.this.loginGameProfile = NetHandlerLoginServer.this.server.getMinecraftSessionService().hasJoinedServer(new GameProfile(
                            null, gameprofile.getName()), s, null);
                        /**
                         * @Niko: idk
                         */
                    ...
                    catch (AuthenticationUnavailableException var3)
                    {
                        ...
                        else
                        {
                            ...
                            NetHandlerLoginServer.logger.error(
